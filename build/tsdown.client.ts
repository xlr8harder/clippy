...
function clientConfig(id: string, entry: string): UserConfig {
  return {
    ...
    outputOptions: {
      // Dsh fetches exactly one client.js closure and its local `require` is
      // the frozen platform-module table, not a chunk loader. Dependencies
      // such as clippyjs use dynamic imports for their atlas/data, so fold
      // every dynamic module into this one deliverable.
      codeSplitting: false,
